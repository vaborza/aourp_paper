# Simulates recruitment using aggregated ZIP3 sites
...
with open(
        f'~/paper_results/zip3_site_{prior}_prior_{update_method}_update_{objective}_objective_{upper_bound_factor}_upper_bound_factor.pickle',
        'wb') as handle:
