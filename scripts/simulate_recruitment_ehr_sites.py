...
with open(f'~/paper_results/ehr_site_{prior}_prior_{update_method}_update_{objective}_objective_{upper_bound_factor}_upper_bound_factor_004_0909.pickle', 'wb') as handle:
